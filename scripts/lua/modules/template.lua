...
template = {
   ...
   ['POST_NAT_SRC_TRANSPORT_PORT'] = 227,
   ['POST_NAT_DST_TRANSPORT_PORT'] = 228,
   ...
   ['NPROBE_INSTANCE_NAME'] = NTOP_BASE_ID+122,
   ...
   ["SIP_UAC"] = NTOP_BASE_ID+316,
   ["SIP_UAS"] = NTOP_BASE_ID+317,
   ...
   ['TCP_WIN_MIN_IN'] = NTOP_BASE_ID+415,
   ['TCP_WIN_MAX_IN'] = NTOP_BASE_ID+416,
   ['TCP_WIN_MSS_IN'] = NTOP_BASE_ID+417,
   ['TCP_WIN_SCALE_IN'] = NTOP_BASE_ID+418,
   ['TCP_WIN_MIN_OUT'] = NTOP_BASE_ID+419,
   ['TCP_WIN_MAX_OUT'] = NTOP_BASE_ID+420,
   ['TCP_WIN_MSS_OUT'] = NTOP_BASE_ID+421,
   ['TCP_WIN_SCALE_OUT'] = NTOP_BASE_ID+422,
   ...
   ['SRC_PROC_PACKAGE_NAME'] = NTOP_BASE_ID+540,
   ...
   ['DST_PROC_PACKAGE_NAME'] = NTOP_BASE_ID+541,
   ...
   -- BGP
   ['CLI_BGP_INFO'] = NTOP_BASE_ID+290,
   ['SRV_BGP_INFO'] = NTOP_BASE_ID+291,
