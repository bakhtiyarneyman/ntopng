local lang = {
   ...
   ["active_monitoring_page"] = {
      ["note_http"] = "Measurement HTTP(S) retrieves a web page using HTTP and HTTPS.",
      ["note_icmp"] = "ICMP not available on Windows.",
      ...
      ["cicmp"] = "Continuous ICMP",
      ["icmp_continuous_v6"] = "Continuous ICMP (IPv6)",
      ["measurement_type"] = "Measurement (Type)",
      ["measurement_value"] = "Last Measurement Value",
      ["last_24_hours"] = "Last 24 Hours",
      ["interface_used"] = "Interface Used",
      ["last_measurement"] = "Last Measurement Time",
      ["threshold"] = "Threshold",
      ["rtt_vs_jitter"] = "Mean RTT / Jitter",
      ["measurement"] = "Measurement",
      ["host_placeholder"] = "Insert an IP or a Domain",
      ["thpt_host_placeholder"] = "Insert an URL (e.g. https://www.google.com)",
   ...
   ["additional_exporters"] = "Additional Exporters (%{value})",
   ["additional_interfaces"] = "Additional Interfaces (%{value})",
   ["admin_status"] = "Administrative Status",
   ["admin_status_short"] = "Admin. Status",
   ["advanced"] = "Advanced",
   ["advanced_charts_test"] = "Advanced Charts Test",
   ["advertised_os"] = "Advertised OS",
   ...
   ["analyze_db_ok"] = "Records are being analysed!",
   ["analyze_db_ok_descr"] = "Historical flows are being analysed, a new virtual network interface (Database) is already available.",
   ["analyze_db_ok_note"] = "Please note historical flow processing is limited by the flow cache size (%{size} entries).",
   ["analyze_pcap"] = "Analyze pcap",
   ...
   ["assets_snmp"] = "Assets Inventory (SNMP)",
   ...
   ["city"] = "City",
   ["classification"] = "Traffic Classification (Since Startup)",
   ["cli_port"] = "Cli Port",
   ...
   ["src_as_dst_as"] = "Source AS / Destination AS",
   ["src_as_transit_as_dst_as"] = "Source AS / Transit AS / Destination AS",
   ...
   ["not_connected_to_the_cloud"] = "Not Connected To The Cloud",
   ...
   ["exporters_info"] = "Exporters Information",
   ["exporter_interface"] = "Exporter - Interface",
   ["exporter_port"] = "%{exporter} - %{port}",
   ["exporters_stats"] = "Ingress/Egress Stats",
   ...
   ["assets_file_too_large"] = "File size exceeds the maximum limit of 2MB.",
   ["filter"] = "Exclude",
   ...
   ["dropping_zmq_msg"] = "ZMQ Messages Drops",
   ["dropping_flows"] = "Dropping Flows",
   ...
   ["flowdev_exporter_site"] = "Flow Device Exporter Site",
   ["flows"] = "Flows",
   ["block"] = "Block",
   ...
   ["import_snmp_devices_fail"] = "Failed to import the devices. Not correctly formatted JSON or some device does not support the SNMP version provided.",
  ...
  ["asset_details"] = {
    ["assets"] = "Asset",
    ["browse_assets"] = "Browse a CSV file with the Assets to import",
    ["import_assets_notes"] = "In case the format is not respected, unknown issue could arise",
    ...
    ["import_error"] = "Error detected while importing data. Please check the validity of the imported file. For further info check the ntopng logs.",
    ["last_time_seen"] = "Last Time Seen",
    ["mail_server"] = "Mail Server",
    ["imap_servers"] = "IMAP Servers",
    ["ssh_servers"] = "SSH Servers",
    ["rdp_servers"] = "RDP Servers",
    ["modbus_server"] = "Modbus Server",
    ["modbus_servers"] = "Modbus Servers",
    ["manufacturer_distribution"] = "Assets By Manufacturer",
    ["model"] = "Model",
    ["mdns_name"] = "MDNS",
    ["mdns_txt_name"] = "MDNS TXT",
    ["merge_wazuh_info"] = "Merge Assets from Wazuh",
    ["merge_wazuh_info_confirm"] = "Do you really want to merge assets information collected using Wazuh?",
    ["merge_wazuh_info_errors"] = "Errors",
    ["merge_wazuh_info_not_found"] = "Assets not found",
    ["merge_wazuh_info_updated"] = "Assets Updated",
    ...
    ["total_online_assets"] = "Total Online Assets",
    ...
    ["wazuh"] = "Wazuh",
    ["wazuh_always_connected"] = "Always connected",
    ["wazuh_asset_information"] = "Wazuh Asset Information",
    ["wazuh_info_available"] = "Wazuh Agent Present",
    ["wazuh_keepalive_dateadd"] = "Last Seen | First Seen",
    ["wazuh_info_not_available"] = "Wazuh Agent Unavailable",
    ["wazuh_os_name_version"] = "OS Name",
    ["wazuh_os_arch_platform"] = "Arch | Platform",
  ...
  ["jump_to_stats"] = "Jump to Statistics",
  ...
  ["modify_flowdev_settings"] = "Modify Flow Device Settings",
  ...
  ["reset"] = "Reset",
  ["reset_bd"] = "Reset Broadcast Domains",
  ...
  ["score_usage"] = 'Avg Score <i class="fa-regular fa-circle-question" data-bs-toggle="tooltip" data-bs-placement="bottom" title="The Score is calculated on the Usage timeserie, the higher the Usage, the higher the Score"></i>',
  ...
  ["ssid"] = "SSID",
  ["stacked"] = "Stacked",
  ["stacked_blocked_title"] = "Stacked option not available for this chart",
  ["stacked_unblocked_title"] = "Toggle stacked chart view",
  ["start"] = "Start",
  ["status"] = "Status",
  ["stop"] = "Stop",
  ["subjectDN"] = "SubjectDN",
  ...
  ["upload_pcap_max_size"] = "File too big, max upload size: 25 MB",
  ...
  ["about"] = {
    ...
    ["flows_hash_size"] = "Flows Hash Size",
    ["flows_limit_exceeded"] = "Flows Limit Exceeded",
    ["flows_limit_exceeded_descr"] = "You have passed the max number of flows suggested for your %{product} license. We suggest you to upgrade to a more capable version.",
    ...
    ["hosts_hash_size"] = "Hosts Hash Size",
    ["hosts_limit_exceeded"] = "Host Limit Exceeded",
    ["hosts_limit_exceeded_descr"] = "You have passed the max number of local hosts suggested for your %{product} license. We suggest you to upgrade to a more capable version.",
    ...
    ["ts_defines"] = "Timeseries Schema Definitions",
    ...
    ["uptime"] = "Uptime",
    ["version"] = "Version",
    ["you_have_too_many_flows"] = "Too many flows for %{product} leading to packet drops and high CPU load. Please tune -X or click the button below to increase the current number. After that restart %{product}",
    ...
    ["you_have_too_many_hosts"] = "Too many hosts for %{product} leading to packet drops and high CPU load. Please tune -x or click the button below to increase the current number. After that restart %{product}",
  ...
  ["acl_page"] = {
      ["all_ports"] = "In case of a Port it is possible to use the wildcard <b>*</b> or the keyword <b>All</b> (case insensitive) to check all the ports",
      ["ports_range"] = "In case of a Port it is moreover possible to configure a port range by specifing the starting and ending port (e.g. 100-200)",
      ["add_acl_rule"] = "Add Rule",
      ["acl_use"] = "A list of rules to whitelist the traffic can be set. When a flow not following the rules appear, an alert is going to be triggered",
      ["non_blocking_rules"] = "This rules are NOT used to block the traffic, they are used to trigger the ACL Violation alert",
      ["add_new_rule"] = "To add a new rule, click the <button type='button' class='btn btn-sm ps-0 pe-0 btn-link'><i class='fas fa-plus'></i></button> button above the table",
      ["action_column"] = "By clicking the action button <button class='btn dropdown-toggle btn-secondary btn-sm' type='button' aria-expanded='false'><span class='fas fa-sm fa-align-justify'></span></button>, it is possible to edit or delete a single rule",
      ["action_delete_all_rules"] = "The <button type='button' class='btn btn-sm btn-danger'><i class='fas fa-trash'></i> Delete All Rules</button> button is going to remove all the configured rules, so use it wisely",
      ["edit_arp_use_mac"] = "In case of ARP protocol, the client needs to be a MAC Address",
      ["edit_acl_required"] = "All the fields are mandatory, except for the 'Notes'",
      ["edit_acl_notes"] = "The 'Notes' are not mandatory; it can be used to remember why the Rule was added",
      ["edit_arp_only_client"] = "In case of ARP protocol, only the client MAC Address is needed (Not IP)",
      ...
      ["add_save"] = "Click on the <button class='btn btn-sm btn-primary'>Add</button> to save the changes",
      ...
      ["advanced_settings_one_rule_per_line"] = "Each rule must be put on a different line, at most one rule per line",
      ["advanced_settings_rule_format"] = "Format of the rules:<br>&nbsp;&nbsp;&nbsp;PROTOCOL;CLIENT;SERVER;L7_PROTO|PORT",
      ["advanced_settings_l7_proto_port"] = "L7_PROTO|PORT field are to be used only with TCP/UDP Protocol and only one of the two is needed",
      ["advanced_settings_select_one_parameter"] = "Only one field, between L7_PROTO and PORT can be used, <b>not</b> both",
      ["advanced_settings_parameters_separator"] = "Each parameter <b>needs</b> to be separated by a <b>;</b> symbol",
      ["error_detected"] = "Error Detected:",
      ["notes"] = "Notes",
      ["remove_rule"] = "Remove Rule",
      ["add_rule_plus"] = "Click the <button class='btn btn-sm btn-link ps-0 pe-0' type='button'><i class='fas fa-plus'></i></button> button to add an other rule, click the <button class='btn btn-danger btn-sm' type='button'><i class='fas fa fa-trash'></i></button> to remove a rule",
      ...
      ["errors"] = {
          ...
          ["incorrect_port_provided"] = "Incorrect port provided, port must be in range between 0 and 65535 [rule: %{rule}]",
          ...
          ["ip_not_recognized"] = "Incorrect IP address provided. Please provide a valid %{host_type} [IP address: %{host}][rule: %{rule}]",
  ...
  ["active_monitoring_stats"] = {
    ...
    ["vulnerability_scan"] = "Active Scan",
    ["validation"] = {
  ...
  ["alert"] = {
    ["graph"] = {
      ...
      ["hist_flows"] = "Historical Flows",
      ["hist_alerts"] = "Historical Alerts",
      ["alert_count"] = "Alerts Count: ",
      ["src_info"] = "Source Information: ",
      ["dst_info"] = "Destination Information: ",
      ["minimum_score"] = "Minimum Score: ",
      ["maximum_alerts"] = "Maximum Alerts: ",
      ["reset"] = "Reset",
      ["ip"] = "IP: ",
      ["apply"] = "Apply",
      ["alerts_topology"] = "Alerts Topology",
      ["no_data"] = "No data available, modify filters",
      ...
      ["alert_summary"] = "Severity Distribution",
      ["total_traffic"] = "Total Traffic: ",
      ["alerts_severity_distribution"] = "Alerts Severity Distribution"
    },
    ["alerts_distribution"] = "Alert types distribution",
    ["alert_error"] = {
      ["configuration"] = {
  ...
  ["alert_messages"] = {
    ...
    ["alert_as_ranking_changed"] = "%{direction} ranking changed to %{current_ranking} from %{previous_ranking} [%{num_changes} change(s)]",
    ...
    ["host_alert_dangerous_host"] = "High Score, limit exceeded by %{entity} [Score: %{score}][Threshold: %{threshold}]",
    ...
    ["host_alert_suspicious_domain_scan"] = "Host %{attacker} probed %{domains} domains on host %{victim}",
    ...
    ["nat_detected"] = "This host is behind a NAT",
    ...
    ["qoe_degraded"] = "QoE is %{qoe} [QoE score: %{qoe_score}]",
    ...
    ["too_many_flows_title"] = "Increase Max Flows",
    ...
    ["traffic_asn_volume_alert"] = "[Metric: %{metric}] [Condition: %{value} %{threshold_sign} %{threshold}] [Check Frequency: %{frequency}]",
    ["traffic_asn_volume_alert_no_metric"] = "[Condition: %{value} %{threshold_sign} %{threshold}] [Check Frequency: %{frequency}]",
  ...
  ["alerts_dashboard"] = {
    ...
    ["alert_host_policy_descr_1"] = "Restricted client connected to a public IP not whitelisted <a href='%{href}'><i class='fas fa-cog fa-sm'></i></a>",
    ["alert_host_policy_descr_2"] = "Restricted client connected to a core host <a href='%{href}'><i class='fas fa-cog fa-sm'></i></a>",
    ["alert_host_policy_descr_3"] = "Core client connected to a non whitelisted host <a href='%{href}'><i class='fas fa-cog fa-sm'></i></a>",
    ...
    ["as_ranking_changed"] = "AS Exporter Ranking Changed",
    ["as_ranking_changed_description"] = "Trigger an alert whenever a configured AS (see Policies -> Network Config -> ASN Config) changed flow exporter ranking",
    ...
    ["dangerous_host_description"] = "Triggers an alert when an Host crosses the configured score threshold for more than 5 minutes consecutively and adds the host to the jailed hosts pool for 30 minutes. Hosts in the jailed hosts pool are prevented from generating traffic when using nProbe in IPS mode.",
    ...
    ["host_alert_domain_names_contacts"] = "Trigger an alert when the number of contacted Domain Names exceed a certain threshold. Never triggered for DNS and SMTP servers",
    ...
    ["host_policy_description"] = "Trigger an alert when a flow does not respect the policies configured in the Network Policy page <a href='" .. ntop.getHttpPrefix() .. "/lua/admin/network_configuration.lua?page=policy'><i class='fas fa-cog fa-sm'></i></a>",
    ...
    ["nat_detected"] = "NAT Detected",
    ["nbox"] = "nBox",
    ["ndpi_dangerous_protocol_title"] = "Dangerous Protocol",
    ...
    ["ndpi_potentially_dangerous_protocol_title"] = "Potentially Dangerous Protocol",
    ...
    ["ndpi_mismatching_protocol_with_ip_title"] = "Mismatching protocol with IP address",
    ["ndpi_mismatching_protocol_with_ip_descr"] = "Mismatching nDPI protocol with server IP address",
    ...
    ["periodicity_is_aperiodic_descr"] = "Flow no longer periodic",
    ["periodicity_is_periodic_descr"] = "New periodic flow detected",
    ["ping_issues"] = "Ping",
    ...
    ["redis_reads_writes_exceeded"] = "Redis Reads Writes Exceeded",
    ["redis_reads_writes_exceeded_descr"] = "Trigger an alert when the number of Redis read and write operations in the last 24 hours is anomalous compared to the rest of the week",
    ["scan_realtime"] = "Scan (Realtime)",
    ...
    ["snmp_interface_mac_changed_script_title"] = "MAC Port Changed",
    ["snmp_interface_mac_detection_script_description"] = "Trigger an alert when a MAC appears/disappears from a device",
    ...
    ["suspicious_domain_scan_title"] = "Susp. Domain Scan",
    ...
    ["vulnerability_scan_title"] = "Active Scan",
    ["warning"] = "Warning",
    ...
    ["tooltips"] = {
      ...
      ["top_as"] = "Autonomous Systems with most alerts",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["domain_names_contacts_description"] = "Trigger an alert when the number of contacted Domain Names exceed a certain threshold. Never triggered for DNS and SMTP servers",
    ...
    ["score_anomaly_description"] = "Detects anomalies (e.g. unexpected changes) in host score value",
  ...
  ["as_overview"] = {
    ...
    ["src_as"] = "Source AS",
    ["as_traffic_criteria"] = "AS Traffic",
  ...
  ["checks"] = {
    ...
    ["factory_reset_all_message"] = "Do you want to reset ALL the checks configuration to the default?",
  ...
  ["db_search"] = {
    ...
    ["network"] = "Network",
    ["no_exact_match"] = "No exact match for %{what} '%{query}'. Search in Historical Data ...",
    ["number"] = "Number",
    ["observation_point_id"] = "Obs. Point ID",
    ...
    ["tags"] = {
      ...
      ["is_cli_attacker"] = "Is Cli Attacker",
      ["is_cli_blacklisted"] = "Is Cli Blacklisted",
      ["is_cli_victim"] = "Is Cli Victim",
      ["is_srv_attacker"] = "Is Srv Attacker",
      ["is_srv_blacklisted"] = "Is Srv Blacklisted",
      ["is_srv_victim"] = "Is Srv Victim",
      ["last_seen"] = "Last Seen",
      ["l4proto"] = "Protocol",
  ...
  ["details"] = {
    ...
    ["flow_exporter"] = "Flow Exporter",
    ["flow_snmp_localization"] = "SNMP Interfaces",
  ...
  ["edit_check"] = {
    ...
    ["tls_certificate"] = "TLS Cert Issuer",
    ["trigger_alert"] = "Trigger Alert on Disconnection",
    ["trigger_device_disconnected_alert"] = "Trigger Alert on Disconnection",
  ...
  ["endpoint_notifications"] = {
    ...
    ["num_drops"] = "Queue Drops",
    ["num_uses"] = "Total Enqueued",
    ["num_filtered_out"] = "Filtered Out",
    ["num_delivered"] = "Delivered",
    ["num_delivery_failures"] = "Failed Deliveries",
  ...
  ["entity_thresholds"] = {
    ["black_hole_contacts_description"] = "Trigger an alert when a client host contacts too many RX-only hosts.",
    ["black_hole_contacts_title"] = "Too Many RX-only Host Contacts",
    ...
    ["nat_detected_description"] = "Trigger an alert when a device is detected behind a NAT.",
    ["nat_detected_title"] = "NAT Detected",
  ...
  ["exporter_sites_page"] = {
    ...
    ["exporters_map"] = "Exporters Map",
    ["exporters_map_notes"] = "The chart depicts exporters traffic volume. For exporter A with an arc towards exporter B, the percentage on A is the amount of traffic A sent to B, and the same arc on B reports the amount of traffic B sent to A.",
    ["sites"] = "Sites",
    ...
    ["exporter_site_color"] = "Site Color",
    ["exporter_site_description"] = "Site Description",
  ...
  ["flow_alerts_explorer"] = {
    ...
    ["status_unexpected_gateway_description"] = "Unexpected Gateway found",
    ...
    ["alert_ndpi_unresolved_hostname_title"] = "Unresolved DNS hostname",
    ["status_ndpi_unresolved_hostname_description"] = "The contacted symbolic hostname (%{server}) was not observed on a previously issued DNS query",
  ...
  ["flow_checks"] = {
    ...
    ["profinet_too_many_errors"] = "Profinet Too Many Errors",
    ["profinet_too_many_errors_description"] = "Trigger an alert when a flow reports a number of errors across all operations exceeding the specified threshold",
    ["profinet_too_many_errors_title"] = "Profinet Too Many Errors",
    ...
    ["suspicious_domain_scan_title"] = "Susp. Domain Scan",
    ["suspicious_domain_scan_description"] = "Trigger an alert when a host is contacting too many domains on another host. Requires Historical Flows (ClickHouse).",
    ...
    ["unexpected_dhcp_description"] = "Trigger an alert when a DHCP server not allowed under Policies / Network Configuration is detected.",
    ["unexpected_dhcp_title"] = "Unexpected DHCP Server",
    ["unexpected_dns_description"] = "Trigger an alert when a DNS server not allowed under Policies / Network Configuration is detected.",
    ["unexpected_dns_title"] = "Unexpected DNS server",
    ["unexpected_gateway_description"] = "Trigger an alert when a Gateway not allowed under Policies / Network Configuration is detected.",
    ["unexpected_gateway_title"] = "Unexpected Gateway",
    ["unexpected_ntp_description"] = "Trigger an alert when a NTP server not allowed under Policies / Network Configuration is detected.",
    ["unexpected_ntp_title"] = "Unexpected NTP server",
    ["unexpected_smtp_description"] = "Trigger an alert when a SMTP server not allowed under Policies / Network Configuration is detected.",
  ...
  ["flow_checks_config"] = {
    ...
    ["dev_proto_not_allowed_description"] = "Trigger an alert when an unusual application is detected for a device. Rules can be configured from the Allowed Applications page.",
    ...
    ["ext_alert_description"] = "Receives flow alerts from external sources (e.g. Suricata via Syslog)",
    ...
    ["malicious_sha1_certificate"] = "Malicious SHA1 TLS Cert.",
    ...
    ["nedge_policy_violation"] = "Policy Violation",
    ["nedge_policy_violation_description"] = "Trigger an alert when a flow is blocked due to a violation of configured policies (e.g. configured max flow size exceeded)",
    ...
    ["qoe_degraded_description"] = "Trigger an alert when a flow has a QoE status of Degraded or Poor",
    ["qoe_degraded_title"] = "QoE Issues",
    ["rare_destination"] = "Rare Destination",
    ...
    ["unresolved_hostname"] = "Unresolved Hostname",
  ...
  ["flow_details"] = {
    ...
    ["src_bgp_info"] = "Client <A HREF='https://en.wikipedia.org/wiki/Border_Gateway_Protocol'>BGP</A> Info",
    ["dst_bgp_info"] = "Server <A HREF='https://en.wikipedia.org/wiki/Border_Gateway_Protocol'>BGP</A> Info",
    ...
    ["flow_peers_client_server"] = "Flow Peers",
    ...
    ["profinet_operations"] = "Operations",
    ["profinet_functions"] = "Functions",
    ["profinet_object_uuid"] = "Object UUID",
    ["profinet_interface_pnio"] = "Interface PNIO",
    ["profinet_activity"] = "Activity",
    ["profinet_num_requests"] = "Requests",
    ["profinet_num_responses_errored"] = "Errors",
    ["profinet_num_responses_ok"] = "Succesfull",
    ["profinet_num_response"] = "Responses",
    ["profinet_dce_rpc_num_response"] = "DCE RPC Responses",
    ["profinet_dce_rpc_num_requests"] = "DCE RPC Requests",
    ["control"] = "Control",
    ["write"] = "Write",
    ["connect"] = "Connect",
    ["release"] = "Release",
    ["read"] = "Read",
    ["read_implicit"] = "Read Implicit",
    ["operation"] = "Operation",
    ["num_requests"] = "Requests",
    ["num_responses_errored"] = "Errors",
    ["num_responses_ok"] = "Success",
    ["modbus_uses"] = "Uses",
    ["modbus_notes"] = "Displayed all the information regarding Modbus, used Registers, Transitions, Exceptions and Function Codes",
    ["modbus_notes_map"] = "The Map can be zoomed in/out by using the mouse wheel and can be moved by using the left click (hold)",
    ["normal"] = "Normal",
    ...
    ["qoe_long"] = "<A class='ntopng-external-link' HREF='https://en.wikipedia.org/wiki/Quality_of_experience'>Network Quality (QoE) <i class='fas fa-external-link-alt'></i></A><br>[ Client->Server / Server ->Client ]",
    ...
    ["tcp_stats_breakdown"] = "TCP Flags Analysis:",
  ...
  ["flow_devices"] = {
    ...
    ["exporter_list_per_obs"] = "Flow Exporter Devices for Obs. Point: %{obs_point}",
    ["exporter_time_last_used"] = "Last Flow Collect Time",
    ...
    ["flow_device"] = "Flow Exporter: %{device}",
    ...
    ["interface_name"] = "Interface Name",
    ["interfaces_count"] = "Total ntopng Exporters Interfaces",
    ...
    ["note_zmq_fields3"] = "This page reports only sFlow counters information.",
    ["note_zmq_fields4"] = "The interface names are determined via SNMP (sFlow does not report this information)",
  ...
  ["flow_fields_description"] = {
    ...
    ["nprobe_ipv4_address"] = "nProbe Exporter IPv4 address",
    ...
    ["tcp_stats_src_to_dst"] = "TCP Stats (client to server)",
    ["tcp_stats_dst_to_src"] = "TCP Stats (server to client)",    
    ...
    ["wtp_mac_address"] = "Access Point MAC Address",
    ...
    ["minor_connection_states_info"] = {
      ...
      ["10"] = "Responder sent a SYN ACK followed by a RST, we never saw a SYN from the originator",
      ["11"] = "Originator sent a SYN followed by a FIN, we never saw a SYN ACK from the responder (“half” open)",
      ["12"] = "Responder sent a SYN ACK followed by a FIN, we never saw a SYN from the originator",
      ["13"] = "No SYN seen, just midstream traffic",
  ...
  ["flow_risk"] = {
    ["malicious_signature_detected"] = "Possibly Client Malicious JA4 Signature",
    ...
    ["ndpi_invalid_characters"] = "Invalid Characters",
  ...
  ["flows_page"] = {
    ...
    ["egress_live_flows"] = "Egress Live Flows",
  ...
  ["graphs"] = {
    ...
    ["num_cve"] = "CVEs",
    ["num_hosts"] = "Hosts",
    ["num_ms_rtt"] = "Server Response Time ms",
    ...
    ["threads_cpu_load"] = "Threads CPU Load",
    ...
    ["remote2local"] = "Remote to Local",
    ["local2remote"] = "Local to Remote",
    ...
    ["tcp_finack_packets"] = "FIN+ACK Packets",
    ["tcp_flags"] = "TCP Flags",
    ...
    ["tcp_syn_packets"] = "SYN Packets",
    ["tcp_syn_vs_tcp_synack"] = "TCP SYN vs SYN+ACK Packets",
    ["tcp_synack_packets"] = "SYN+ACK Packets",
    ...
    ["metric_descr"] = {
      ...
      ["top_blacklist_hits"] = "Number of blacklist hits",
      ["iface_new_flows"] = "Number of new flows per interface",
      ["iface_remote2local"] = "Bytes from remote to local per interface",
      ["iface_local2remote"] = "Bytes from local to remote per interface",
      ["iface_total_alerted_flows"] = "Number of alerted flows per interface",
      ["iface_active_hosts"] = "Number of active hosts per interface",
      ["iface_engaged_alerts"] = "Number of engaged alerts per interface",
      ["iface_dropped_alerts"] = "Number of dropped alerts per interface",
      ["iface_active_devices"] = "Number of active devices per interface",
      ["iface_active_http_servers"] = "Number of active HTTP servers per interface",
      ["iface_traffic"] = "Total traffic in bytes per interface",
      ["iface_throughput_bps"] = "Throughput in bits per second per interface",
      ["iface_throughput_pps"] = "Throughput in packets per second per interface",
      ["iface_score"] = "Client and server score per interface",
      ["iface_packets_vs_drops"] = "Packets vs drops per interface",
      ["iface_num_nfq_pct"] = "NFQ percentage per interface",
      ["iface_hosts_anomalies"] = "Local and remote host anomalies per interface",
      ["iface_discarded_probing_bytes"] = "Discarded probing bytes per interface",
      ["iface_discarded_probing_packets"] = "Discarded probing packets per interface",
      ["iface_dumped_flows"] = "Dumped and dropped flows per interface",
      ["iface_zmq_received_flows"] = "ZMQ received flows per interface",
      ["iface_zmq_flow_coll_drops"] = "ZMQ flow collector drops per interface",
      ["iface_zmq_flow_coll_udp_drops"] = "ZMQ flow collector UDP drops per interface",
      ["iface_tcp_packets_lost"] = "TCP lost packets per interface",
      ["iface_tcp_packets_ooo"] = "TCP out-of-order packets per interface",
      ["iface_tcp_packets_retr"] = "TCP retransmitted packets per interface",
      ["iface_tcp_packets_keep_alive"] = "TCP keep-alive packets per interface",
      ["iface_tcp_syn_packets"] = "TCP SYN packets per interface",
      ["iface_tcp_synack_packets"] = "TCP SYN-ACK packets per interface",
      ["iface_tcp_finack_packets"] = "TCP FIN-ACK packets per interface",
      ["iface_tcp_flags"] = "TCP Flags per interface",
      ["iface_zmq_msg_rcvd"] = "ZMQ messages received per interface",
      ["iface_zmq_msg_dropped"] = "ZMQ messages dropped per interface",
      ["iface_tcp_rst_packets"] = "TCP RST packets per interface",
      ["host_traffic_rxtx"] = "Bytes sent and received per host",
      ["host_score"] = "Client and server score per host",
      ["host_active_flows"] = "Number of active flows as client and server per host",
      ["host_total_flows"] = "Total flows as client and server per host",
      ["host_num_blacklisted_flows"] = "Blacklisted flows as client and server per host",
      ["host_total_alerted_flows"] = "Alerted flows as client and server per host",
      ["host_total_unreachable_flows"] = "Unreachable flows as client and server per host",
      ["host_unreachable_flows"] = "Host-unreachable flows as client and server per host", --
      ["host_active_contacts"] = "Contacts as client and server per host",
      ["host_contacts_behaviour"] = "Host contacts behaviour per host",
      ["host_alerts"] = "Alerts per host",
      ["host_engaged_alerts"] = "Engaged alerts per host",
      ["host_dns_qry_sent_rsp_rcvd"] = "DNS query packets, OK replies and error replies received per host",
      ["host_dns_qry_rcvd_rsp_sent"] = "DNS query packets, OK replies and error replies sent per host",
      ["host_tcp_rx_stats"] = "Retransmitted, out-of-order and lost TCP packets received per host",
      ["host_tcp_tx_stats"] = "Retransmitted, out-of-order and lost TCP packets sent per host",
      ["host_udp_packets"] = "UDP packets sent and received per host",
      ["host_echo_reply_packets"] = "ICMP echo-reply packets sent and received per host",
      ["host_echo_request_packets"] = "ICMP echo-request packets sent and received per host",
      ["host_tcp_packets"] = "TCP packets sent and received per host",
      ["host_udp_sent_unicast_vs_non_unicast"] = "UDP unicast vs non-unicast bytes per host",
      ["host_dscp_classes"] = "DSCP class bytes sent and received per host",
      ["host_tcp_unidirectional_flows"] = "Unidirectional TCP flows as client and server per host",
      ["mac_traffic_rxtx"] = "Bytes sent and received per MAC",
      ["subnet_traffic"] = "Bytes egress, ingress and inner per subnet",
      ["subnet_broadcast_traffic"] = "Broadcast bytes egress, ingress and inner per subnet",
      ["subnet_engaged_alerts"] = "Engaged alerts per subnet",
      ["subnet_score"] = "Score, as client and server per subnet",
      ["subnet_tcp_packets_retr"] = "TCP retransmitted packets ingress, egress and inner per subnet",
      ["subnet_tcp_packets_ooo"] = "TCP out-of-order packets ingress, egress and inner per subnet",
      ["subnet_tcp_packets_lost"] = "TCP lost packets ingress, egress and inner per subnet",
      ["subnet_tcp_packets_keep_alive"] = "TCP keep-alive packets ingress, egress and inner per subnet",
      ["subnet_rtt"] = "Round-trip time per subnet",
      ["asn_traffic_rxtx"] = "Bytes sent and received per ASN",
      ["asn_rtt"] = "Round-trip time per ASN",
      ["asn_traffic_sent"] = "Bytes sent per ASN",
      ["asn_traffic_rcvd"] = "Bytes received per ASN",
      ["asn_score"] = "Score per ASN (total, client and server score)",
      ["asn_tcp_packets_retr"] = "TCP retransmitted packets sent and received per ASN",
      ["asn_tcp_packets_keep_alive"] = "TCP keep-alive packets sent and received per ASN",
      ["asn_tcp_packets_ooo"] = "TCP out-of-order packets sent and received per ASN",
      ["asn_tcp_packets_lost"] = "TCP lost packets sent and received per ASN",
      ["country_traffic"] = "Bytes egress, ingress and inner per country",
      ["country_score"] = "Score per country (total, client and server score)",
      ["os_traffic_rxtx"] = "Bytes sent and received per operating system",
      ["vlan_traffic_rxtx"] = "Bytes sent and received per VLAN",
      ["vlan_score"] = "Score per VLAN (total, client and server score)",
      ["host_pool_traffic_rxtx"] = "Bytes sent and received per host pool",
      ["host_pool_blocked_flows"] = "Blocked flows per host pool",
      ["host_pool_active_hosts"] = "Active hosts per host pool",
      ["host_pool_active_devices"] = "Active devices per host pool",
      ["pod_active_flows"] = "Active flows as client and server per pod",
      ["pod_containers"] = "Number of containers per pod",
      ["pod_avg_rtt"] = "Round-trip time as client and server per pod",
      ["pod_avg_rtt_variance"] = "RTT variance as client and server per pod",
      ["container_active_flows"] = "Active flows as client and server per container",
      ["container_avg_rtt"] = "Round-trip time as client and server per container",
      ["container_avg_rtt_variance"] = "RTT variance as client and server per container",
      ["ht_cpu_load"] = "CPU load hash idle and active entries",
      ["ht_HostHash"] = "HostHash idle and active entries",
      ["ht_MacHash"] = "MacHash idle and active entries",
      ["ht_FlowHash"] = "FlowHash idle and active entries",
      ["ht_AutonomousSystemHash"] = "AutonomousSystemHash idle and active entries",
      ["ht_ObservationPointHash"] = "ObservationPointHash idle and active entries",
      ["ht_VlanHash"] = "VlanHash idle and active entries",
      ["system_cpu_load"] = "I/O wait, idle and active CPU percentage",
      ["process_memory"] = "Process resident memory in bytes",
      ["process_alerts"] = "Process written, queried and dropped alerts",
      ["threads_cpu_load"] = "CPU utilization percentage per thread",
      ["profile_traffic"] = "Bytes per profile",
      ["redis_ram_memory"] = "Redis memory usage in bytes",
      ["redis_keys"] = "Number of Redis keys",
      ["redis_reads_writes"] = "Redis read and write operations count",
      ["influxdb_storage_utilization"] = "InfluxDB storage utilization in bytes",
      ["influxdb_ram_memory"] = "InfluxDB memory usage in bytes",
      ["influxdb_write_througput"] = "InfluxDB write successes (points)",
      ["influxdb_exports_label"] = "Number of InfluxDB exports",
      ["influxdb_exported_points"] = "Number of points exported by InfluxDB",
      ["influxdb_dropped_points"] = "Number of points dropped by InfluxDB",
      ["influxdb_num_ms_rtt"] = "InfluxDB round-trip time in milliseconds",
    },
    ["metric_labels"] = {
      ["alerted_flows"] = "Alerted Flows",
      ["alerts"] = "Alerts",
  ...
  ["host_config"] = {
    ["active_monitor_enable"] = "Active Monitoring is currently disabled, please enable it to access this feature. It can be enabled from the <a href=\"" .. ntop.getHttpPrefix() .. "/lua/admin/prefs.lua?tab=active_monitoring\">Preferences</a> (Restart required)",
  ...
  ["host_details"] = {
    ...
    ["asset_x"] = "%{host} [Asset]",
    ["inconsistent_host_os"] = "Inconsistent operating system detected: is this host a gateway, NAT or VPN server perhaps?",
    ...
    ["drop_host_flows_btn"] = "Drop Only Active Host Flows",
    ["drop_host_traffic_btn"] = "Drop All Host Traffic",
    ["allow_host_traffic_btn"] = "Allow All Host Traffic",
  },
  ["host_log_collector"] = {
  ...
  ["host_pools"] = {
    ...
    ["block_blacklisted"] = "Block Blacklisted Flows",
    ["block_blacklisted_descr"] = "Block flows with the Blacklisted risk detected",
    ...
    ["flush"] = "Flush",
    ["flush_blacklist"] = "Flush Blacklist",
    ["flush_blacklist_confirm"] = "Do you want to reset all blacklisted hosts?<br /><strong>%{hosts}</strong> host(s) currently blacklisted.",
    ...
    ["invalid_network_address"] = "Invalid network address format",
    ["network_address_required"] = "Network Address Required",
    ["num_blacklist_hosts"] = "%{hosts} host(s) blacklisted",
    ["invalid_member"] = "Invalid member address format",
    ["invalid_mac"] = "Invalid MAC Address Format",
    ["mac_required"] = "MAC address Required",
    ["invalid_vlan"] = "Invalid VLAN Value",
    ["invalid_cidr_range"] = "Invalid CIDR Range",
    ["ip_address"] = "IP Address",
    ["ip_filter"] = "IPv4/IPv6",
    ["ipv4"] = "IPv4",
    ["ipv6"] = "IPv6",
    ...
    ["manage_pool"] = "Manage Members",
    ["manage_pools"] = "Manage Pool Membership",
    ["manufacturer_filter"] = "Manufacturer: %{manufacturer}",
    ["max_flow_size"] = "Max Flow Size (MB)",
    ["max_flow_size_descr"] = "Max size of a single flow (flows exceeding the configured size are blocked)",
    ...
    ["remove_member_pool"] = "Are you really sure to remove the member: '%{member}' from the pool?",
  ...
  ["hosts_stats"] = {
    ...
    ["page_scan_hosts"] = {
      ...
      ["vs_result"] = "Scan Report for %{host} at %{date}",
  ...
  ["if_stats_config"] = {
    ...
    ["add_rules_type_flow_exporter"] = "Flow Exporters",
    ...
    ["delete_traffic_description"] = "Are you sure to delete the selected Host Rule?",
    ["delete_traffic_title"] = "Delete Rule",
    ["discard_probing_traffic"] = "Discard Probing Traffic",
    ["dump_flows_to_database"] = "Dump Flows to Database",
    ["edit_traffic_title"] = "Edit Rule",
    ...
    ["host_threshold_rules"] = "JSON Traffic Rules",
  ...
  ["internals"] = {
    ...
    ["queues"] = "Queues",
    ["rrd_drops"] = "TS Drops",
    ["snmp_fat_mibs"] = "SNMP Fat MIBs",
    ["snmp_other_mibs"] = "SNMP Other MIBs",
  ...
  ["limits_page"] = {
    ...
    ["max"] = "Max",
    ["num_flows"] = "Active Flows",
    ["num_flow_exporter_interfaces"] = "Flow Exporters Interfaces",
    ["num_flow_exporters"] = "Flow Exporters",
    ["num_hosts"] = "Active Hosts (All)",
    ["num_local_hosts"] = "Active Local Hosts",
    ["num_host_pools"] = "Host Pools",
    ["num_pool_members"] = "Host Pools Members (Default Pool Excluded)",
  ...
  ["mfa"] = {
    ...
    ["tab_title"] = "MFA",
    ["enter_code_prompt"] = "Enter the 6-digit code from your authenticator app.",
    ["wrong_code"] = "Invalid code. Please try again.",
    ["verify"] = "Verify",
    ["back_to_login"] = "Back to login",
    ["description"] = "Protect your account with a Time-based One-Time Password (TOTP) authenticator app such as Google Authenticator, Authy, or similar.",
    ["setup_button"] = "Set Up MFA",
    ["disable_button"] = "Disable MFA",
    ["enable_button"] = "Enable MFA",
    ["disable_confirm_button"] = "Confirm Disable",
    ["status_enabled"] = "Enabled",
    ["status_disabled"] = "Disabled",
    ["status_enabled_desc"] = "Two-factor authentication is active for this account.",
    ["status_disabled_desc"] = "Two-factor authentication is not enabled.",
    ["setup_step1"] = "Step 1: Scan this QR code with your authenticator app",
    ["setup_step2"] = "Step 2: Enter the 6-digit code to confirm setup",
    ["passkey_disabled"] = "Passkey is disabled while MFA is enabled.",
    ["passkey_disabled_http"] = "Passkey requires a secure context (HTTPS or localhost).",
    ["passkey_enabled"] = "MFA is disabled while a Passkey is enabled.",
    ["manual_entry"] = "Or enter this secret manually:",
    ["disable_warning"] = "Enter your current TOTP code to confirm disabling MFA.",
  ...
  ["manage_configurations"] = {
    ...
    ["clean_installation"] = "It is recommended to import the configuration on a clean installation only (or after a Factory Reset).",
    ["checks"] = "Behavioural Checks",
  ...
  ["manage_users"] = {
    ...
    ["allow_historical_flows_descr"] = "Allow the user to access Historical Flows and Reports, filtered based on Allowed Networks and Pools.",
    ["allow_pcap_download"] = "Allow PCAP Download",
    ["allow_pcap_download_descr"] = "Allow the user to download live traffic and PCAPs.",
    ["allowed_host_pools"] = "Allowed Host Pools",
    ["allowed_host_pools_descr"] = "Select the host pools this user can access. Leave empty to allow access to all pools.",
  ...
  ["nedge"] = {
    ...
    ["dhcp_option_114"] = "Redirection URL",
    ["dhcp_option_114_descr"] = "DHCP Option 114. Commonly used as Captive Portal URL. (Optional)",
    ["dhcp_option_160"] = "Provisioning Server URL",
    ...
    ["rescan_interfaces"] = "Rescan Interfaces",
    ["rescan_interfaces_msg"] = "Do you want to rescan network interfaces? Doing that you will be asked to reboot and all the network interface configurations will be lost",
    ["rescan_and_reboot"] = "Rescan and Reboot",
    ["rescan_and_restart_self"] = "Rescan and Reboot",
  ...
  ["network_configuration"] = {
    ...
    ["ntp_servers_description"] = "A list of comma separated NTP Servers IPs",
    ["dhcp_servers_description"] = "A list of comma separated DHCP Servers IPs",
    ["smtp_servers_description"] = "A list of comma separated SMTP Servers IPs",
    ["gateway_servers_description"] = "A list of comma separated Gateway Servers IPs",
    ["local_devices_title"] = "Restricted Hosts (e.g. Servers, VPN servers)",
    ["corporate_devices_title"] = "Core Hosts (e.g. Routers, Switches)",
    ["whitelisted_networks_title"] = "Whitelisted Hosts",
    ["empty_policy"] = "Empty file, no Network Policies found",
    ["successfully_imported"] = "Network Policies successfully imported",
    ["json_extraction_error"] = "JSON Extraction error, error while parsing the JSON",
    ["local_devices_description"] = "A list of networks (CIDR) whose hosts have outbound connection restrictions.",
    ["corporate_devices_description"] = "A list of networks (CIDR) whose hosts have outbound connection restrictions.",
    ["whitelisted_networks_description"] = "A list of whitelisted hosts (CIDR) or MAC addresses.",
    ["network_policy"] = "Policies",
    ["import_policies"] = "Import Policies",
    ["import_network_policies_error"] = "Error while importing Network Policies, please check the imported file",
    ["export_policies"] = "Export Policies",
    ["browse_network_policies"] = "Browse a JSON file with the Network Policies",
    ["import_network_policies_notes"] = "In case the format is not respected, unknown issue could arise",
    ...
    ["uses_of_servers"] = "An alert is triggered whenever:<ul><li>A restricted host connects to a public IP address not whitelisted.</li><li>A restricted host connects to a core host.</li><li>A core host connects to any non whitelisted address.</li></ul>Unidirectional TCP flows or reset (RST) are not considered by the 'Host Policy' check, as well flows with whitelisted clients.",
  ...
  ["llm"] = {
    ...
    ["input_price_per_million"] = "Input Price (1M Tokens)",
    ["output_price_per_million"] = "Output Price (1M Tokens)",
    ...
    ["register_model"] = "Add Model Cost",
    ["register_model_price"] = "Add Model Price",
    ["edit_model_price"] = "Edit Model Price",
    ["price_hint_input"] = "Cost per 1M input (prompt) tokens in USD",
    ["price_hint_output"] = "Cost per 1M output (completion) tokens in USD",
    ["local_provider_price_note"] = "Local LLM providers typically have no API cost.",
    ["custom_model_name"] = "Custom model name",
    ["delete_model_price"] = "Delete Model Price",
    ["model_already_registered"] = "This provider/model combination is already registered",
    ["model_price_saved"] = "Model price saved successfully",
    ["model_price_deleted"] = "Model price deleted successfully",
    ["confirm_delete_price_body"] = "Are you sure you want to delete the price entry for model '{model}'?",
    ["1h"] = "1h",
    ["6h"] = "6h",
    ["24h"] = "24h",
    ["7d"] = "7d",
  ...
  ["page_stats"] = {
    ...
    ["average"] = "Average",
    ["usage"] = {
      ["congestion_rate"] = 'Congestion Rate (<i class="fa-solid fa-circle-arrow-down" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Downlink" style="color: #90EE90"></i> / <i class="fa-solid fa-circle-arrow-up"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Uplink" style="color: #C6D9FD"></i>)',
      ...
      ["average"] = 'Average (<i class="fa-solid fa-circle-arrow-down" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Downlink" style="color: #90EE90"></i> / <i class="fa-solid fa-circle-arrow-up"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Uplink" style="color: #C6D9FD"></i>)',
      ["last_value"] = 'Last Value (<i class="fa-solid fa-circle-arrow-down" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Downlink" style="color: #90EE90"></i> / <i class="fa-solid fa-circle-arrow-up"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Uplink" style="color: #C6D9FD"></i>)',
      ["uplink"] = "Uplink",
      ["downlink"] = "Downlink",
    },
  ...
  ["policy"] = {
    ...
    ["autoconfigure_sites_note"] = "In order to populate Traffic Rules, the Auto Configure feature requires the Top Visited Sites heuristic to be enabled under Settings > Preferences > Applications. For best results it should be enabled at least one day before to collect enough data.",
    ["continent"] = "Continent",
  ...
  ["prefs"] = {
    ...
    ["llm_model_title"] = "Model Name",
    ["llm_anthropic_url_description"] = "Base URL for the Anthropic API endpoint",
    ["llm_anthropic_token_description"] = "API key for the Anthropic API",
    ["llm_anthropic_model_description"] = "Anthropic model name to use (e.g. claude-opus-4-6)",
    ["llm_openai_url_description"] = "Base URL for the OpenAI API endpoint",
    ["llm_openai_token_description"] = "API key for the OpenAI API",
    ["llm_openai_model_description"] = "OpenAI model name to use (e.g. gpt-4o)",
    ["llm_local_url_description"] = "Base URL for the local LLM API endpoint (e.g. http://localhost:11434)",
    ["llm_local_token_description"] = "Authentication token for the local LLM API, if required",
    ["llm_local_model_description"] = "Local model name to use",
    ["asn_mode"] = "ASN Mode",
    ...
    ["aggregated_flows_data_retention_descr"] = "Number of days to keep aggregated flows information (it must be larger than unaggregated flows retention). Default: 60 days.",
    ["aggregated_flows_data_retention_title"] = "Aggregated Flows Data Retention",
    ["aggregated_asn_data_retention_descr"] = "Number of days to keep aggregated asn information (it must be larger than unaggregated asn retention). Default: 30 days.",
    ["aggregated_asn_data_retention_title"] = "Aggregated ASN Data Retention",
    ["vs_reports_data_retention_title"] = "Vulnerability Scan Report Data Retention",
    ["vs_reports_data_retention_descr"] = "Number of days to keep the vulnerability scans report. Default: 30 days.",
    ...
    ["clickhouse_ts_grafana_dashboard_description"] = "Download a sample Grafana dashboard pre-configured to visualize ntopng timeseries stored in ClickHouse. Requires the <a href='https://grafana.com/grafana/plugins/grafana-clickhouse-datasource/' target='_blank'>grafana-clickhouse-datasource</a> plugin.",
    ...
    ["exclude_from_usage"] = "Exclude From Usage",
    ["exclude_from_usage_description"] = "By default, all the devices/interfaces are included in the SNMP Usage Page, if the user is not interested in analyzing this device/interface, enable this preference to remove it from the Usage Page",
    ...
    ["flow_cache_settings"] = "Flows Cache Settings",
    ["flow_deduplication_title"] = "Enable Flow Deduplication",
    ["flow_deduplication_description"] = "Toggle to enable or disable flow deduplication",
    ...
    ["http_index_page"] = "Index Landing Page",
    ["http_index_page_description"] = "Specify the URL of the index landing page that is set to /lua/index.lua as default",
    ...
    ["l2_devices_timeseries"] = "MAC Addresses Timeseries",
    ["last_seen"] = "Last Seen",
    ...
    ["mac_address_cache_duration_title"] = "MAC Address Idle Timeout",
    ...
    ["message_brokers_description"] = "Select the message broker to use. This broker is going to be used to export information regarding ntopng",
    ...
    ["multiple_timeseries_database_description"] = "The driver used for storing and retrieving timeseries data.<br><b>Notes:</b><ul><li>ClickHouse connection parameters (host, port, user, password) are configured with the -F option (flows dump to ClickHouse should be enabled).</li><li>It's possible to use InfluxDB v.2 with a compatible v.1 bucket, however the Retention and the Buckets have to be managed by the InfluxDB GUI.<br>Minimum InfluxDB version supported: <b>1.5.1</b></li></ul>",
    ...
    ["snmp_interface_role_description"] = "SNMP interface port role",
    ...
    ["system_probes_timeseries"] = "System Timeseries",
    ...
    ["toggle_asset_inventory_log_description"] = "Enable the creation of the asset inventory database.",
    ["toggle_asset_inventory_log_title"] = "Enable Asset Inventory",
    ["toggle_flow_swap_heuristic"] = "Flow Swap Heuristic",
    ["toggle_flow_swap_heuristic_description"] = "Enable the flow swap heuristic to automatically swap flows with wrong client-server direction.",
    ["toggle_skip_dpi_for_collected_flows"] = "Skip Local DPI for Collected Flows",
    ["toggle_skip_dpi_for_collected_flows_description"] = "Skip local DPI processing for flows collected from remote probes (e.g. via ZMQ) as they already include protocol information. As drawback, some of the local behavioural checks are not performed.",
    ...
    ["toggle_dns_cache_description"] = "Creates a DNS cache in memory used to resolve host names. A <b>ntopng restart</b> is required if this preference is modified.",
    ...
    ["toggle_dump_pcap_to_clickhouse_description"] = "Dump flows accounted on a pcap interface into ClickHouse. Alerts are always dumped.",
    ["toggle_dump_pcap_to_clickhouse_title"] = "Dump Pcap Interfaces Flows",
    ...
    ["path_export_flows_to_archive_description"] = "Specify The Folder Path To Archive Flows To: i.e. /var/log/",
    ["path_export_flows_to_archive_title"] = "Flows Archive Path",
    ...
    ["toggle_enable_full_stats"] = "Enable Full Flow Statistics",
    ["toggle_enable_full_stats_description"] = "Toggle to enable or disable full flow traffic statistics.",
    ...
    ["toggle_exporter_interface_usage_timeseries_title"] = "Flow Exporters Interface Usage",
    ["toggle_exporters_ndpi_ts_creation_description"] = "Toggle the creation of Layer 7 Application timeseries for exporters.",
    ["toggle_exporters_ndpi_ts_creation_title"] = "Flow Exporters L7 Application",
    ...
    ["toggle_fingerprint_stats_description"] = "Enable localhost fingerprint statistics, and unknown fingerprints database (stored on redis ntopng.unknown_tcp_fingerprints) used to improve classification.",
    ...
    ["toggle_flow_aggregated_limit_title"] = "Limit Aggregated Flows",
    ...
    ["toggle_flow_aggregated_traffic_limit_title"] = "Minimum Aggregated Flow Traffic",
    ...
    ["toggle_flow_rrds_resolution_description"] = "This indicates the frequency of updates for each Flow Exporter / nProbe timeseries",
    ["toggle_flow_rrds_resolution_title"] = "Flow Exporters and nProbes Timeseries Resolution",
    ...
    ["toggle_ldap_ext_user_cap_description"] = "Enable additional capabilities for LDAP users which are Non-Administrator (e.g. historical flow access)",
    ["toggle_ldap_ext_user_cap_title"] = "Enable Extended Users Capabilities",
    ...
    ["toggle_assets_log_description"] = "Toggle the generation of tracing for the assets",
    ["toggle_assets_log_title"] = "Enable Assets Log",
    ["toggle_assets_inventory_description"] = "Toggle the generation of assets. If enabled, the 'Assets Inventory' page can be found in the Hosts Menu.",
    ["toggle_assets_inventory_title"] = "Enable Assets Inventory",
    ...
    ["toggle_message_broker_description"] = "Enable sending statistics and information to a message broker.",
    ...
    ["toggle_query_performance_log_description"] = "Log execution time for SQL queries on historical data that take more than 1s to complete.",
    ["toggle_query_performance_log_title"] = "SQL Queries Performance Log",
    ...
    ["oidc_issuer_url_title"] = "Issuer URL (Identity Provider)",
    ["oidc_issuer_url_description"] = "The base URL of the OIDC identity provider. The discovery document will be fetched from <issuer>/.well-known/openid-configuration.",
    ["oidc_client_id_title"] = "Client ID",
    ["oidc_client_id_description"] = "The OAuth2 client ID registered at the identity provider.",
    ["oidc_client_secret_title"] = "Client Secret",
    ["oidc_client_secret_description"] = "The OAuth2 client secret associated with the client ID.",
    ["oidc_base_redirect_uri_title"] = "Base Redirect URI (ntopng)",
    ["oidc_base_redirect_uri_description"] = "The publicly reachable base URL of this ntopng instance (e.g. https://ntopng.example.com:3000). The callback URL registered at the IdP must be <base>/oidc_callback.",
    ["oidc_scopes_title"] = "Scopes",
    ["oidc_scopes_description"] = "Space-separated list of OIDC scopes to request. Default: openid profile email roles.",
    ["oidc_group_claim_title"] = "Group Claim",
    ["oidc_group_claim_description"] = "Name of the JWT claim that carries group membership (used to determine admin role). Default: groups.",
    ["oidc_admin_group_title"] = "Admin Group",
    ["oidc_admin_group_description"] = "Value of the group claim that grants administrator privileges. Leave empty to make all OIDC users unprivileged.",
    ["toggle_oidc_auth"] = "Toggle OIDC Authentication",
    ["toggle_oidc_auth_descr"] = "Enable Single Sign-On via an OpenID Connect identity provider (Keycloak, Okta, Azure AD, Google, etc.).",
    ["toggle_oidc_auto_create_users_title"] = "Auto-Create Users",
    ["toggle_oidc_auto_create_users_description"] = "Automatically create an ntopng account on the first OIDC login. When disabled, the user must be pre-created manually.",
    ["oidc_claim_ifname_title"] = "Allowed Interface Attribute",
    ["oidc_claim_ifname_description"] = "JWT claim name whose string value is set as the user's allowed interface. Leave empty to not source this attribute from the JWT.",
    ["oidc_claim_nets_title"] = "Allowed Networks Attribute",
    ["oidc_claim_nets_description"] = "JWT claim name whose string value is set as the user's allowed networks (multivalue or comma-separated CIDR list). Leave empty to not source this attribute from the JWT.",
    ["oidc_claim_host_pools_title"] = "Allowed Host Pools Attribute",
    ["oidc_claim_host_pools_description"] = "JWT claim name whose string value is set as the user's allowed host pool IDs (multivalue or comma-separated). Leave empty to not source this attribute from the JWT.",
    ["oidc_claim_allow_pcap_title"] = "Allow Live Traffic & PCAP Download Attribute",
    ["oidc_claim_allow_pcap_description"] = "JWT claim name whose boolean value controls whether the user may download live traffic and PCAPs. Leave empty to not source this attribute from the JWT.",
    ["oidc_claim_allow_historical_title"] = "Allow Historical Flows & Reports Attribute",
    ["oidc_claim_allow_historical_description"] = "JWT claim name whose boolean value controls whether the user may access historical flows and reports. Leave empty to not source this attribute from the JWT.",
    ["oidc_claim_allow_alerts_title"] = "Allow Alerts Attribute",
    ["oidc_claim_allow_alerts_description"] = "JWT claim name whose boolean value controls whether the user may access alerts. Leave empty to not source this attribute from the JWT.",
    ...
    ["toggle_system_probes_timeseries_description"] = "Toggle the creation of timeseries for monitoring the system, e.g. Redis timeseries, CPU/Memory timeseries...",
    ["toggle_system_probes_timeseries_title"] = "System",
    ["toggle_toggle_starttls_title"] = "Enable STARTTLS",
    ["toggle_toggle_starttls_description"] = "Enable the use of STARTTLS when trying to connect to the email server.",
    ...
    ["toggle_split_ts_direction_title"] = "Split Timeseries Directions",
    ...
    ["ts_and_stats_data_retention_descr"] = "Retention (days) for InfluxDB and ClickHouse timeseries and top talkers. Default: 30 days.<br><b>Note:</b><ul><li>An ntopng restart is required to change the retention policy.</li><li>If InfluxDB v.2 with a compatible v.1 bucket is used, the retention policy does not work.</li></ul>",
    ...
    ["webhook_send_error"] = "Error while delivering message to the webhook. Please check the webhook address/credentials, URL and its code implementation.",
    ["webhook_sent_successfully"] = "A message has been succesfully to the webhook",
    ...
    ["wazuh_url_description"] = "Wazuh REST URL. Usually something like https://WAZUH_HOST:55000/. Note that if your Wazuh server is accessed over https without a valid certificate (e.g. a self-signed certificate), you need to start ntopng using --insecure.",
    ["wazuh_username_title"] = "Wazuh Username",
    ["wazuh_username_description"] = "Wazuh REST API username. Usually wazuh-wui",
    ["wazuh_password_title"] = "Wazuh Password",
    ["wazuh_password_description"] = "Wazuh API password",
    ["wifi"] = "Wireless",
  ...
  ["report"] = {
    ...
    ["top_receiver_as_exporter_if"] = "Top Receiver AS By Exporter Interface",
    ...
    ["top_sender_as_exporter_if"] = "Top Sender AS By Exporter Interface",
    ["asn_flows"] = "ASN Flows",
  ...
  ["rest_consts"] = {
    ...
    ["MERGE_WAZUH_INFO_FAILED"] = "Unable to merge Wazuh information. Please check the provided API.",
  ...
  ["scripts_overview"] = {
    ...
    ["ts_info_measure_unit"] = "Measure Unit",
    ["ts_info_schema"] = "Schema",
    ["ts_info_timeseries"] = "Timeseries",
    ["type"] = "Type",
  },
  ["severity_groups"] = {
  ...
  ["show_alerts"] = {
    ...
    ["traffic_rules_percentage"] = "Symbol '>' means a positive percentage threshold, otherwise '<' means a negative percentage threshold.",
    ["traffic_rules_percentage_absolute"] = "The threshold value must be: 0 <= threshold <= 100.",
    ["hourly"] = "Hourly",
  ...
  ["snmp"] = {
    ...
    ["chart_congestion_rate_color"] = "Each bar in the chart can have 4 different colors: <br><div class='d-inline-flex justify-content' style='background-color: rgb(144, 238, 144); height: 8px; width: 8px;'></div>: Congestion rate between 0 and 24<br><div class='d-inline-flex justify-content' style='background-color: rgb(25, 135, 84); height: 8px; width: 8px;'></div>: Congestion rate between 25 and 49<br><div class='d-inline-flex justify-content' style='background-color: rgb(255, 193, 7); height: 8px; width: 8px;'></div>: Congestion rate between 50 and 75<br><div class='d-inline-flex justify-content' style='background-color: rgb(220, 53, 69); height: 8px; width: 8px;'></div>: Congestion rate between 76 and 100",
    ["chart_congestion_rate_note"] = "The chart shows the congestion rate of the various Interfaces (In and Out separated). Calculated by dividing the number of points with usage higher or equal than 76% and the number of total points",
    ["contact"] = "Contact",
    ["cpuIdle"] = "CPU Idle",
    ...
    ["snmp_device_poll_duration"] = "Poll Duration",
    ...
    ["descriptions"] = {
      ...
      ["context"] = "SNMPv3 context (e.g. the VRF name)",
  ...
  ["system_stats"] = {
    ...
    ["clickhouse"] = {
      ...
      ["clickhouse_alerts_number"] = "Alerts (Flow Alerts Excluded)",
  ...
  ["traffic_recording"] = {
    ...
    ["max_extracted_pcap_bytes_description"] = "Maximum size for PCAP files. In case this size is exceeded, the output will be split into multiple files.",
    ["max_extracted_pcap_bytes_title"] = "Max Extracted File Size",
    ["max_extracted_pcap_files_description"] = "Maximum number of PCAP files.",
    ["max_extracted_pcap_files_title"] = "Max Extracted PCAP Files",
    ...
    ["snaplen"] = "Packet Capture Length",
    ["snaplen_note"] = "Maximum number of bytes to dump for each captured packet",
  ...
  ["vulnerability_scan"] = {
    ...
    ["vulnerability_scan_in_progress"] = "Vulnerability Scan in Progress",
